...
vehicle_ids = [2926, 2928,2902,2903,2907, 2911 ]
'''
2913
2918
2924
...
with open("one_day_data.json", "w") as f:
#with open("one_day_data.jsonl", "w") as f:
    json.dump(all_data, f, indent=2)

#print(f"{all_data}")
print(f"Saved {len(all_data)} records to one_day_data.json")
